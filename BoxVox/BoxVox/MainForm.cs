...
namespace BoxVox
{
    public partial class MainForm : Form
    {
        ...
        // Previous note.
        public int prevNote1 = -1;
        // Current note;
        public int currNote1 = -1;
        // Previous octave.
        public int prevOctave1 = -1;
        // Current octave.
        public int currOctave1 = -1;

        // Previous note.
        public int prevNote2 = -1;
        // Current note;
        public int currNote2 = -1;
        // Previous octave.
        public int prevOctave2 = -1;
        // Current octave.
        public int currOctave2 = -1;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (serialPort1.BytesToRead != 0)
                {
                    ...
                    currNote1 = Convert.ToInt32(decMessage[0]);
                    currNote2 = Convert.ToInt32(decMessage[1]);
                    currOctave1 = Convert.ToInt32(decMessage[2]);
                    currOctave2 = Convert.ToInt32(decMessage[3]);
